 ...
 */
public class StudyBuddyBook implements ReadOnlyStudyBuddyBook {
    ...
    public StudyBuddyBook() {}

    /**
     * Creates an AddressBook using the Persons in the {@code toBeCopied}
     */
    public StudyBuddyBook(ReadOnlyStudyBuddyBook toBeCopied) {
        this();
     ...
     */
    public void resetData(ReadOnlyStudyBuddyBook newData) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof StudyBuddyBook // instanceof handles nulls
                && persons.equals(((StudyBuddyBook) other).persons));
    }
